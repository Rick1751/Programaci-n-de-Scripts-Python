...
#+date: 2025-01-19
#+author: Ricardo León 
#+email: ricardo.leon02@epn.edu.ec
#+language: Español
#+select_tags: export
...
#+begin_export latex
\fancyhead[C]{\includegraphics[scale=0.15]{logoEPN.jpg}\\
...
Escribir un programa que permita obtener el alcance del cohete
...
** Trayectoria sin resistencia (B=0)
file:Figure_0.png
** Trayectoria con resistencia (B=0.1)
[[file:Figure_1.png]]
